...
import lk.daraz.wishlistservice.dto.ApiErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleWishlistNotFound(WishlistNotFoundException ex, WebRequest request) {
